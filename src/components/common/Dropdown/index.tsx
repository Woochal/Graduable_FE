...
export default function Dropdown<T>({ 
	...
	return (
	  <S.Container width={width} height={height} onClick={() => setIsOpen(!isOpen)} ref={dropdownRef}>
		<S.SelectedItem>
			{selectedData ? getLabel(selectedData) : <S.Placeholder>{placeholder}</S.Placeholder>}
