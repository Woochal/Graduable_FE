...
export default function GraduationInfo({ onComplete, onSkip }: GraduationInfoProps) {
        ...
        <>
            <Container>
                <Box>
                    ...
                    <Subtitle>졸업 심사 결과를 알려주시면, 알려주신 정보를 바탕으로 맞춤 세팅 해드릴게요.</Subtitle>
                    ...
                    <StepContainer>
                        <StepItem>
                            <StepCOntent>
                                ...
                                <StepTitle>
                                    히즈넷에 로그인 한 뒤, '내 졸업 심사 정보로 이동하기'를 클릭해주세요.
                                </StepTitle>
                            </StepCOntent>
                            <ActionButtons>학사정보 → 졸업 → 졸업심사결과조회 → 졸업심사결과보기</ActionButtons>
                        </StepItem>

                        <StepItem>
                            <StepCOntent>
                                <StepNumber>2.</StepNumber>
                                <StepTitle>해당 페이지에서 전체 선택 후 복사를 해주세요.</StepTitle>
                            </StepCOntent>
                            <StepDescription>
                                좌우 메뉴, 불필요한 것 같은 정보들이 포함되어도 괜찮아요. 전체 선택 후 복사해주세요.
                            </StepDescription>
                            <div style={{ display: 'flex', flexDirection: 'row' }}>
                                <StepDescription>Graduable이 필요한 정보만 불러올게요!</StepDescription>
                                <StepDescription1>(일부 정보가 누락될 수 있으니, 꼭 확인해주세요 !)</StepDescription1>
                            </div>
                        </StepItem>
