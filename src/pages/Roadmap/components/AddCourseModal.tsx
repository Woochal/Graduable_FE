...
import { editSemesterRoadmapAPI } from '../../../axios/RoadmapApi';
...
const AddCourseModal: React.FC<AddCourseModalProps> = ({ isOpen, onClose, semester, semesterNumber, semesterData }) => {
    const [searchTerm, setSearchTerm] = useState('');
    const [selectedCourses, setSelectedCourses] = useState<Course[]>(semesterData);
    ...
    const handleSaveCourses = async () => {
        try {
            const selectedIdList = selectedCourses.map((course) => course.id);
            const response = await editSemesterRoadmapAPI(userData.googleId, semesterNumber, selectedIdList);
        } catch (error) {
        ...
        <AddCourseModalOverlay>
            <AddCourseModalContent>
                ...
                <AddCourseButtonContainer>
                    ...
                    <AddCourseSaveButton onClick={handleSaveCourses}>저장하기</AddCourseSaveButton>
                </AddCourseButtonContainer>
            </AddCourseModalContent>
        </AddCourseModalOverlay>
    );
